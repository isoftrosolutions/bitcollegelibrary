...
if ($user['is_verified'] == 0) {
    $page_title = "Library Card Pending";
    require_once '../includes/header.php';
    echo '<div class="container py-5 mt-5 text-center">
            <div class="card book-card p-5 border-0 shadow-sm d-inline-block" style="max-width: 600px;">
                <i class="fas fa-clock fa-4x text-warning mb-4"></i>
                <h3>Verification Pending</h3>
                <p class="text-gray lead">Your library card is currently being processed by the administration. Please check back later.</p>
                <a href="dashboard.php" class="btn btn-register mt-3">Back to Dashboard</a>
            </div>
          </div>';
...
<div class="container py-5 mt-5">
    <div class="text-center mb-5">
        <h1 class="hero-title">Library <span class="text-teal">Card</span></h1>
        <p class="hero-subtitle">Your digital library pass is ready. You can print this page to get your physical card.</p>
    </div>
    ...
    <div class="no-print d-flex justify-content-center gap-3">
        <button onclick="window.print()" class="btn btn-register py-3 px-5">
            <i class="fas fa-print me-2"></i> Print Library Card
        </button>
        <a href="dashboard.php" class="btn btn-outline-teal py-3 px-5">Back to Dashboard</a>
    </div>
</div>
